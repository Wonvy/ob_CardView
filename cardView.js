...
class CardView extends obsidian_1.ItemView {
    ...
    createViewSwitcher(container) {
        ...
        views.forEach(view => {
            ...
            iconSpan.innerHTML = iconHtml[view.icon]; // 明确类型
            // 添加文字
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const filteredFiles = files.filter(file => {
                ...
                if (this.currentFilter.type === 'date') {
                    ...
                    if (((_c = this.currentFilter.value) === null || _c === void 0 ? void 0 : _c.length) === 7) {
                        // 按月份过滤
...
class EnhancedFileSelectionModal extends obsidian_1.Modal {
    ...
    moveFiles(targetFolder) {
        return __awaiter(this, void 0, void 0, function* () {
            const confirmModal = new ConfirmModal(this.app, "确认 移动", `是否将选中的 ${this.files.length} 个文件移动到 "${targetFolder}"？`);
